            ...
            <div class="col-md-12 grid-margin">
                <div class="shadow">
                    <div class="card-header py-3">
                        <h3 class="m-0 font-weight-bold">Edit Data Alat</h3><br>
                        <div class="flash-data" id="flash5" data-flash="<?= $this->session->flashdata('gagal');?>"></div>
                        <div class="col-md-12 grid-margin">
                            <div class="card shadow mb-12">
                                <div class="col-lg-12 grid-margin stretch-card">
                                    <div class="card">
                                        <form method="POST" action="<?php echo base_url('stok_alat/update'); ?>" enctype="multipart/form-data"></br>
                                            <div class="form-group">
                                                <input type="hidden" name="idalat" class="form-control" value="<?php echo $edit->idalat ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Gambar </label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="namaalat" class="form-control" value="<?php echo $edit->namaalat ?>" required>
                                                <?php echo form_error('namaalat', '<div class="text-small text-danger"></div>') ?>
                                            </div>
                                            <div class="form-group">
                                                <label>Kelengkapan </label>
                                                <input type="text" name="deskripsi" class="form-control" value="<?php echo $edit->deskripsi ?>"required>
                                                <?php echo form_error('deskripsi', '<div class="text-small text-danger"></div>') ?>
                                            </div>
                                            <div class="form-group">
                                                <label>Jumlah Alat</label>
                                                <input type="number" name="stock" class="form-control" value="<?php echo $edit->stock ?>" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="kondisi" id="kondisi" class="form-control" required>
                                                    ...
                                                    <option value="Kurang Baik" <?php if($edit->kondisi == 'Kurang Baik'){echo 'selected';}?>>Kurang Baik</option>
                                                </select>
