    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center" style="padding: 0 0 0 5px;">
                <a class="navbar-brand brand-logo" href="<?php echo base_url(); ?>dashboard"><img src="<?= base_url('assets'); ?>/images/LogoInventarisLab.png" /></a>
            </div>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav" style="padding-right: -10px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url(); ?>stok_alat" aria-expanded="false">
